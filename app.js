...
//   if(pageName==="about")
//   {
//     res.render(pageName,{start:aboutContent})
//   }
//   else if(pageName==="contact")
//   {
//     res.render(pageName,{start:contactContent})
//   }
//   else
//   {
//     res.render(pageName)
...
app.get("/:user",function(req,res)
{
  ...
  Article.findOne({name:anotherPosts},function(err,results)
  {
    if(err)
    {
      console.log(err);
  ...
  // posts.forEach(function(results)
  // {
  //   if(anotherPosts===_.lowerCase(results.title))
  //   {
  //      res.render("post",{head:results.title,text:results.context})
